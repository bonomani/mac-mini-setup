...
# YAML loaders extracted 2026-04-28 to lib/uic_yaml.sh.
# shellcheck source=lib/uic_yaml.sh
source "${BASH_SOURCE[0]%/*}/uic_yaml.sh"

# Global-state display + hard-gate abort (extracted 2026-04-29).
# shellcheck source=lib/uic_state.sh
source "${BASH_SOURCE[0]%/*}/uic_state.sh"
