...
_UCC_YAML_BATCH_KEYS="profile actions.install actions.update \
  ...
  driver.fallback_install_args driver.update_cmd \
...
# Component / layer dispatch (extracted 2026-04-29).
# shellcheck source=lib/run_components.sh
source "${DIR}/lib/run_components.sh"
