...
# Schema constants extracted 2026-04-29 to _targets_validator_schema.py.
from _targets_validator_schema import (  # noqa: E402
    KNOWN_PROFILES,
    KNOWN_TARGET_TYPES,
    KNOWN_STATE_MODELS,
    KNOWN_UPDATE_CLASSES,
    KNOWN_PLATFORMS,
    DRIVER_META,
    DRIVER_SCHEMA,
...
# Condition parsing extracted to _targets_validator_conditions.py 2026-04-28.
from _targets_validator_conditions import (  # noqa: E402
    _host_match_values,
    _host_named_values,
    _version_compare,
...
# Dep-graph helpers extracted 2026-04-29 to _targets_validator_depgraph.py.
from _targets_validator_depgraph import (  # noqa: E402
    PKG_BACKEND_META,
    _pkg_backend_names,
    _driver_implicit_dep,
    _driver_implicit_deps_all,
    _driver_provided_by,
    _target_dep_union,
